...
- [x] **Aesthetics**: Integrated with a custom-formatted minimalist status bar featuring a Pure Black background, subtle white inactive elements, and a high-contrast Peppermint Teal focal window with modern icons (`⸎`).
- [x] **Sublime-Inspired Aesthetics**: Enhanced Tmux configuration with Pure Black backgrounds, vibrant Peppermint Teal active accents (`#14b8a6`), and subtle Bright Black pane borders (`#2a2a2a`) for an immersive editor-like feel.
