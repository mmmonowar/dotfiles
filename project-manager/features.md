...
- **AI & LLM Aliases**: Context-aware aliases for Gemini CLI (`gemini`, `gemini-flash`, `gemini-pro`) that are conditionally enabled based on the git user email, optimizing for cost and performance.
